...
.noto-count{position:absolute;top:-12px;right:-13px;display:block;width:20px;height:20px;font-size:10px;line-height:20px;font-family: 'Conv_helveticaneuecyr-bold';color:#fff;background:#0d58c8;text-align:center;-webkit-border-radius:20px;-moz-border-radius:20px;border-radius:20px;}
...
.noto-popup{display:none;position:absolute;top:82px;right:15px;border:1px solid #edeff2;background:#fff;width:500px;text-align:left;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;}
...
.noto-entry:after{content:'';position:absolute;top:43px;left:24px;display:block;width:12px;height:12px;background:#d1d3d7;border:2px solid #fff;-webkit-border-radius: 12px;-moz-border-radius: 12px;border-radius: 12px;}
...
.noto-message{display:inline-block;font-size:12px;line-height:18px;font-weight:400;color:#7a8192;background:#f6f6f7;border:1px solid #edeff2;padding: 5px 9px;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;}
.noto-message a{color:#0d58c8;}
.noto-message a:hover{color:#7a8192;}
.noto-left{float:left;margin-right:15px;}
.noto-header{
	padding:20px 0px;border-top:1px solid #edeff2;border-bottom:1px solid #edeff2;
	.form-checkbox{float:left;height: 36px;line-height: 36px;margin-bottom: 0px;}
	.form-checkbox > input + .check{position:relative;top: 5px;}
	.stat-sort{float:right;margin-top:0px;}
	.form-checkbox > input{top: 3px;}
	label{font-size:10px;line-height:30px;font-weight:400;color:#7a8192;text-transform:uppercase;margin-left:7px;}
}
.noto-entry.style-2{
	margin-left:0px;margin-right:0px;
	.noto-content{margin-left:0px;padding-left:30px;padding-right:30px;}
	.noto-message{background:transparent;border:none;padding:0px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;width: 100%;}
	&:before, &:after{display:none;}
}
.noto-entry.style-3{
	margin-left:0px;margin-right:0px;
	.form-checkbox{position:absolute;top:34px;left:10px;z-index:100;}
	.form-checkbox > input + .check{background:#fff;}
	.noto-content{position:relative;margin-left:0px;padding-left:40px;padding-right:30px;}
	.noto-message{background:transparent;border:none;padding:0px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;width: 100%;}
	&:before, &:after{display:none;}
...
.be-drop-down .login-user{-webkit-border-radius: 40px;-moz-border-radius: 40px;border-radius: 40px;}
...
@media screen and (min-width: 1200px){
	...
	.header-menu>li:hover>ul{-webkit-transition: all ease-out 0.5s; -moz-transition: all ease-out 0.5s; -o-transition: all  ease-out 0.5s; transition: all   0.5s; -webkit-transform: perspective(500px) rotateX(0deg); -moz-transform: perspective(500px) rotateX(0deg); -ms-transform: perspective(500px) rotateX(0deg); transform: 		perspective(500px) rotateX(0deg); opacity: 1; }
	.header-menu>li>ul li:hover{background: #0d58c8;}
	.header-menu>li>ul li:hover > a{color: #FFF;		}
	.header-menu>li>ul{position: absolute; top: 100%; left: 0; color: #262626; text-align: left; background: #FFF; width: 100%; min-width:150px; padding-top: 0px; font-size: 16px; opacity: 0; -webkit-transform-origin: 50% 0; -moz-transform-origin: 50% 0; -ms-transform-origin: 50% 0; transform-origin: 50% 0; -webkit-transition: all  ease-out 0.5s; -moz-transition: all  ease-out 0.5s; -o-transition: all  ease-out 0.5s; transition: all  ease-out 0.5s; -webkit-transform: rotateX(-90deg); -moz-transform: rotateX(-90deg); -o-transform: rotateX(-90deg); -ms-transform: rotateX(-90deg); transform: rotateX(-90deg); }
	.header-menu>li>ul>li{position: relative;}
	.header-menu>li>ul>li i{position: absolute; top: 50%; right: 10px; -webkit-transform:translateY(-50%); -moz-transform:translateY(-50%); -ms-transform: translateY(-50%); transform: translateY(-50%);}
	.header-menu>li>ul>li>ul{position: absolute; top: 0px; left: 100%; padding-top: 0px; width: 150px !important; text-align: left; background: #FFF; color: #262626; width: auto; font-size: 16px; opacity: 0; -webkit-transform-origin: 0 50%; -moz-transform-origin: 0 50%; -ms-transform-origin: 0 50%; transform-origin: 0 50%; -webkit-transition: all ease-out 0.5s; -moz-transition: all ease-out 0.5s; -o-transition: all ease-out 0.5s; transition: all ease-out 0.5s; -webkit-transform: rotateY(90deg); -moz-transform: rotateY(90deg); -o-transform: rotateY(90deg); -ms-transform: rotateY(90deg); transform: rotateY(90deg);
	}
	.header-menu>li>ul>li:hover>ul{-webkit-transition: all ease-out 0.5s; -moz-transition: all ease-out 0.5s; -o-transition: all ease-out 0.5s; transition: all  0.5s; -webkit-transform: perspective(500px) rotateY(0deg); -moz-transform: perspective(500px) rotateY(0deg); -ms-transform: perspective(500px) rotateY(0deg); transform: perspective(500px) rotateY(0deg); opacity: 1; }
	.cmn-toggle-switch{display: none;}
}
@media screen and (max-width: 1199px){
	.brand-be{position: absolute; left: 50%; text-align: center; -webkit-transform: translateX(-50%) !important; -moz-transform: translateX(-50%) !important; -ms-transform: translateX(-50%) !important; transform: translateX(-50%) !important;}
	.fa-angle-right{display: none;}
	.fa-angle-down, .fa-angle-up{display: block; position: absolute; right: 15px; top: 10px; -webkit-transform:translateY(-50%); -moz-transform:translateY(-50%); -ms-transform:translateY(-50%); transform: translateY(-50%);}
	header{z-index: 550;}
...
.head-bg.style-2{
	padding-top:120px;padding-bottom:120px;margin-bottom:0px;
	.head-bg-img{opacity:0.5;}
	.head-bg-content{height:310px;}
}
.head-bg.style-3{
	padding-top:120px;padding-bottom:120px;margin-bottom:0px;background:#181d27;
	.head-bg-img{opacity:0.2;}
	.head-bg-content{height:310px;}
}
...
.creative_filds_block a:not(:first-child),
.creative_filds_block .nav>li:not(:first-child)>a{
	border-top: none !important;
}
.creative_filds_block a:hover,
.creative_filds_block .nav>li>a:hover,
.creative_filds_block .nav>li.active>a{
	background: #0d58c8;
	color: #FFF !important;
}
.creative_filds_block a:hover:after{
	content: "\f105";
...
#content-block .tags_block li a:last-child{
	margin-bottom:10px;
}
...
.filter-block li.be-active{
	background: #0d58c8;
	color: #FFF;
}
.filter-block li.be-active>i{
	color: #FFF !important;
}
...
.portfolio-link{
	...
	img{display:block;float:left; width: 33.33333333%;height: auto;}
	.color_bg{display:block;position:absolute;top:0px;right:0px;bottom:0px;left:0px;background:#0d58c8;opacity:0;}
	.color_bg:hover{opacity:0.85;}
	.color_bg span{display: inline-block;vertical-align: middle;font-size:12px;line-height:12px;text-transform:uppercase; color:#fff;margin-right:0px;}
	.color_bg span.child{display: inline-block;vertical-align: middle;height: 100%;width: 0px;}
	&.type-2 img{width: 20%;}
}
@media screen and (max-width:1199px){
...
.be-drop-down{
	position: relative; display: block; font-size:13px; color: #b4b7c1; background: #FFF; padding: 15px 80px 15px 50px; margin-bottom:10px; border: 1px solid #edeff2; cursor: pointer; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;
	&:hover{border: 1px solid #0d58c8;}
	.drop-down-list{border-left: 1px solid #0d58c8;border-right: 1px solid #0d58c8;}
	&.color-2{background:#f6f6f7;}
	&.color-2:hover{background:#fff;color:#b4b7c1;}
	&.color-2 .drop-down-list{border-left: 1px solid #f6f6f7;border-right: 1px solid #f6f6f7;}
	&.color-2 .drop-down-list a{background:#f6f6f7;color:#b4b7c1;}
	&.color-2 .drop-down-list a:hover{background:#fff;color:#b4b7c1;}
	&.color-2.be-drop-down:hover i{color:#b4b7c1;}
	&.color-2.be-dropdown-active:hover{background:#f6f6f7;}
	&.color-2.be-dropdown-active i{color:#b4b7c1;}
	&.color-2.be-dropdown-active:after{color:#b4b7c1;}
	&.color-3{background:#383b43;color:#fff;border: 1px solid #383b43;}
	&.color-3:hover{background: #0d58c8;color: #FFF;border: 1px solid #0d58c8;}
	&.color-3.be-dropdown-active:hover{background:#383b43;border: 1px solid #383b43;}
	&.color-3 .drop-down-list{background:#383b43;border-left: 1px solid #383b43;border-right: 1px solid #383b43;}
	&.color-3 .drop-down-list a{color:#b4b7c1;}
	&.color-3 .drop-down-list a:hover{color:#fff;}
	&.color-3 .fa{color:#b4b7c1;}
	&.color-4{background:#0d58c8;color:#fff;  border: 1px solid #0d58c8;}
	&.color-4 .fa{color:#869edc;}
	&.color-4 .drop-down-list{background:#383b43;border-left: 1px solid #383b43;border-right: 1px solid #383b43;}
	&.color-4 .drop-down-list a{color:#b4b7c1;}
	&.color-4 .drop-down-list a:hover{color:#fff;}
	&.size-2{font-size:10px; padding: 18px 50px 17px 32px;}
	&.icon-none{padding: 14px 80px 14px 18px;}
}
.be-drop-down>i{position:absolute;top:50%;font-size: 18px; left: 20px;-webkit-transform:translateY(-50%);-moz-transform:translateY(-50%);-ms-transform:translateY(-50%);transform: translateY(-50%);}
.be-drop-down:hover, .be-drop-down.be-dropdown-active{background: #0d58c8; color: #FFF; }
.be-drop-down.be-dropdown-active:after{webkit-transform:translateY(-50%) rotate(180deg); -moz-transform:translateY(-50%) rotate(180deg); -ms-transform:translateY(-50%) rotate(180deg); transform: translateY(-50%) rotate(180deg); }
...
.be-drop-down:after{content:"\f107";font-family:FontAwesome;font-size:18px;position:absolute;top:50%;right:25px; webkit-transform:translateY(-50%) rotate(0);-moz-transform:translateY(-50%) rotate(0);-ms-transform:translateY(-50%) rotate(0);transform: translateY(-50%) rotate(0);}
@media screen and (max-width: 1200px){
...
.be-post .be-img-block img{width: 100%; height: auto; position: relative; -webkit-transition: all ease-out 0.3s; -moz-transition: all ease-out 0.3s; -o-transition: all ease-out 0.3s; transition: all 0.3s; }
.be-post .be-img-block img:hover{-webkit-transform:scale(1.1); -moz-transform:scale(1.1); -ms-transform:scale(1.1); transform: scale(1.1); }
...
.be-large-post .info-block.style-2{margin-bottom: 50px;}
.be-post.style-2{
	padding-top:15px; padding-bottom: 15px;
	.be-post-date{font-size:12px; line-height:18px; font-weight:400; color:#b4b7c1; margin: 0 15px 15px 15px;}
	.be-post-date .fa{  font-size: 18px; position: relative; top: 2px; margin-right:5px;}
	.be-post-title{padding-bottom: 0px;margin: 0 15px 15px 15px;border-bottom:none;}
	.be-img-block:after{display:none;}
}
.be-post.style-3{
	padding-bottom: 15px;
	.be-post-title{padding-bottom: 0px;margin: 0 15px 15px 15px;border-bottom:none;min-height: initial;}
	.be-img-block:after{display:none;}
}
.be-post.style-4{
	.be-post-title{border-bottom:none;}
	padding-bottom:15px;
}
.be-post.style-5{
	.be-img-block{margin-bottom: 0px;}
	.be-rowline{margin:0px 10px;padding: 10px 0px;}
	.be-rowline + .be-rowline{border-top:1px solid #edeff2;}
	.rowline-img{float:left;width:30px;height:30px;margin-right:15px;-webkit-border-radius: 30px;-moz-border-radius: 30px;border-radius: 30px;}
	.rowline-text{font-size:11px;line-height:30px;font-weight:400;color:#b4b7c1;}
	.rowline-icon{font-size:13px; float:right;}
	.author-post{font-size:10px;line-height:20px;font-weight:400;padding:10px;background:#f6f6f7;}
	.author-post .fa{font-size:14px;position:relative;top:1px;margin-right:3px;}
}
...
.soc_buttons .fa{position:absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%);}
...
.galerry img{margin:8px;border-radius:4px;width:50px;opacity:0.2;-webkit-transition:ease-out 0.1s all;-moz-transition:ease-out 0.1s all;-o-transition:ease-out 0.1s all;transition: ease-out 0.1s all;}
...
.submit-block i{position:absolute;top:0px;right:50%;font-size:22px;line-height: 45px;color:rgba(255,255,255,0.7);-webkit-transform:translateX(50%);-moz-transform:translateX(50%);-ms-transform:translateX(50%);transform:translateX(50%); }
...
.soc-activity .soc_ico_triangle i{position:absolute;top:50%;left:45%;-webkit-transform:translateY(-60%) translateX(-55%);-moz-transform:translateY(-60%) translateX(-55%);-ms-transform:translateY(-60%) translateX(-55%);transform: translateY(-60%) translateX(-55%); }
...
.check-box>.checkbox-input:checked + .check-box-sign:after{
	content: "\f00c";
	font-family: FontAwesome;
	color: #0d58c8;
	position: absolute;
...
.be-popup-sign-button:hover{
	background: #0040b0;
}
.be-date-block .large-popup-tex{
	display: block;
}
.large-popup span{
	color: 	#727785;
...
.be-date-block .large-popup-text{
	display: block;
	margin-bottom: 20px;
}
...
.be-custom-select-block:hover::after{
	color: #0d58c8;
}
.be-date-block .be-custom-select-block{
	display: inline-block;
}
.be-date-block .be-custom-select-block{
	width: 130px;
...
@media screen and (max-width: 991px){
	...
	.large-popup.register .be-popup-sign-button{
		float: left;
	}
}
/*=========================================
...
.color-3-10 {
    background-color: #e8df56;
}

.color-3-11 {
    background-color: #a9c75e;
}
...
.color-4-2 {
    background-color: #2b11ea;
}

.color-4-3 {
    background-color: #7211ea;
}
...
.be-use-name{color: #262626;font-size:16px;font-family: 'Conv_helveticaneuecyr-bold';margin-bottom:15px;overflow:hidden;text-overflow:ellipsis;white-space: nowrap}
...
.be-follow-type:hover{background: rgb(0, 50, 162);}
.be-message-type:hover{background-color: rgb(150, 150, 150); color: #FFF !important;}
...
.be-user-counter{position:absolute;top:15px;left:15px; width:57px;height:57px;background:#0d58c8;-webkit-border-radius: 57px;-moz-border-radius: 57px;border-radius: 57px; padding-top: 8px;}
...
.be-user-social{
	max-width: 240px;margin: 0 auto;border-bottom: 1px solid #EDEFF2;
}
...
.social-btn{
	position:relative;display:inline-block;width:33px;height:33px;color:#fff;line-height:33px;text-align:center;margin:0px 0px;-webkit-border-radius: 2px;-moz-border-radius: 2px;border-radius: 2px;
	&.color-1{background:#3c599f;}
	&.color-2{background:#1ab2e8;}
	&.color-3{background:#dc4a38;}
	&.color-4{background:#cc2028;}
	&.color-5{background:#417199;}
	&.color-6{background:#006699;}
}
...
.be-user-block.style-2, .be-user-block.style-3{
	padding:30px 15px 15px 15px;text-align:center;
	.be-use-name{font-size:20px;line-height:26px;font-weight:400;margin-bottom:5px;height:26px;}
	.be-user-info{font-size:13px;line-height:18px;font-weight:400;margin-bottom:10px;}
	.be-text-tags{border-bottom:1px solid #edeff2;border-top:1px solid #edeff2;padding:15px 0px;margin-bottom:20px;  height: 50px;overflow: hidden;text-overflow: ellipsis;white-space:nowrap;}
	.be-text-tags a{font-size:13px;line-height:18px;font-weight:400;color:#b4b7c1;}
	.be-text-tags a:hover{color: #0D58C8;}
	.info-block{background:transparent;padding:0px;margin-bottom:25px;}
	.btn{margin:0 auto 30px auto;}
	.be-user-detail{margin-bottom:60px;}
}
...
.share-buttons a{display:inline-block; width:66px; height:33px;line-height:33px;color:#fff;margin-top:1px;-webkit-border-radius: 2px;-moz-border-radius: 2px;border-radius: 2px;}
...
.message-popup-inner{position:absolute;left:50%;top:50%;-webkit-transform: translate(-50%,-50%);-moz-transform:    translate(-50%,-50%);-ms-transform:     translate(-50%,-50%);-o-transform:      translate(-50%,-50%);transform:         translate(-50%,-50%);}
...
.be-desc-img{float:left;width:70px;height:70px;margin-bottom:15px;-webkit-border-radius: 70px;-moz-border-radius: 70px;border-radius: 70px;}
...
.be-button-vidget.blue-style{
	background: #0d58c8;
	color: #FFF !important;
}
.be-button-vidget.blue-style .fa{
	color: #8da4e0 !important;
}
.be-button-vidget .fa{
	margin-right: 5px;
}
.be-button-vidget.blue-style:hover{
	  background: rgb(0, 50, 162);
}
.be-button-vidget.grey-style:hover{
	  background-color: rgb(150, 150, 150);
  color: #FFF !important;
}
.be-button-vidget.grey-style{
	background: #F6F6F6;
	border: 1px solid #edeff2;
...
.be-large-post .be-post-title:hover{text-decoration: none;cursor: default;}
...
.be-large-post .letf-menu-article{
	font-size: 16px;
}
.be-large-post{
	border: 1px solid #edeff2;
...
.thumbnails .swiper-slide{
	...
	&:before{content:''; position:absolute; top:0px; left:0px; right:0px; bottom:0px; background:rgba(34, 40, 53, 0.8); -webkit-transition:ease-out 0.2s all; -moz-transition:ease-out 0.2s all; -o-transition:ease-out 0.2s all; transition: ease-out 0.2s all;cursor:pointer; }
	&.current:before, &:hover:before{background:rgba(0, 0, 0, 0.0);}
}
...
/*buttons*/
.btn{
	display:inline-block; font-size:12px; line-height:12px; font-weight:400; color:#fff; text-transform:uppercase;margin-bottom:10px;margin-right:27px;-webkit-border-radius:3px;-moz-border-radius:3px; border-radius:3px;
	&.color-1{background:#0d58c8; border:1px solid #0d58c8;}
	&.color-1 .fa{color:#8ba1dd;}
	&.color-2{background:#383b43; color:#fff;}
	&.color-2 .fa{color:#7a8192;}
	&.color-3{background:#fff; color:#7a8192;border:1px solid #7a8192;}
	&.color-3 .fa{color:#7a8192;}
	&.color-4{background:#f6f6f7; color:#7a8192;border:1px solid #edeff2;}
	&.color-4 .fa{color:#7a8192;}
	&.color-5{background:transparent;border:1px solid #edeff2; color:#b4b7c1;}
	&.color-6{background:#7a8192;color:#fff;}
	&.color-7{background:transparent;color:#9fa5b5;border:1px solid #414856;}
	&.size-1{padding: 15px 28px;}
	&.size-2{font-size:10px; line-height:10px; padding: 12px 19px 10px 19px;}
	&.size-3{font-size:9px; line-height:9px; padding: 9px 10px;}
	&.size-4{font-size:10px; line-height:10px; padding: 19px;}
	&.active{-webkit-box-shadow: none;box-shadow: none;}
	&.hover-1:hover, &.hover-1.active{background:transparent; border:1px solid #0d58c8; color:#0d58c8;}
	&.hover-1:hover .fa, &.hover-1.active .fa{color:#0d58c8;}
	&.hover-2:hover, &.hover-2.active{background:transparent; border:1px solid #0d58c8; color:#fff;}

	&.hover-3:hover, &.hover-3.active{background:transparent; border:1px solid #383b43; color:#383b43;}
	&.hover-4:hover, &.hover-4.active{background:transparent; border:1px solid #383b43; color:#fff;}

	&.hover-5:hover, &.hover-5.active{background:#7a8192; border:1px solid #7a8192; color:#fff;}
	&.hover-6:hover, &.hover-6.active{background:transparent; border:1px solid #7a8192; color:#fff;}

	&.hover-7:hover, &.hover-7.active{background:transparent; border:1px solid #edeff2; color:#7a8192;}
	&.hover-8:hover, &.hover-8.active{background:transparent; border:1px solid #edeff2; color:#fff;}
	&.hover-9:hover, &.hover-9.active{background:#0d58c8; border:1px solid #0d58c8; color:#fff;}
	&.hover-9:hover .fa, &.hover-9.active .fa{color:#fff;}

	&.hover-10:hover, &.hover-10.active{background:transparent;border:1px solid #7A8192; color:#7A8192;}
	&.hover-10:hover .fa, &.hover-10.active .fa{color:#7A8192;}

	&.full{width:100%;margin-right:0px;}
	&.btn-right{float:right;margin-right:0px;margin-left:20px;}
	&.btn-input{margin-top:33px;}
	.fa{margin-right:10px;}
}
/*inputs*/
.form-group{
	position:relative;margin-bottom:30px;
	.form-input{font-size:13px; line-height:50px; font-weight:400; color:#b4b7c1; width:100%; height:50px; padding-left:20px; padding-right:20px; border:1px solid #edeff2; -webkit-border-radius:3px; -moz-border-radius:3px; border-radius:3px;
	}
	textarea.form-input{height:150px;}
	.form-group-icon{position:absolute; top:50%; right:20px; color:#b4b7c1; -webkit-transform: translateY(-50%); -moz-transform: ranslateY(-50%);-ms-transform:translateY(-50%);-o-transform:translateY(-50%);transform:translateY(-50%);}

	&.fg_icon .form-input{padding-right:40px;}
	&.fl_icon .form-input{padding-left:70px;}
	&.fl_icon .icon{position:absolute;top:1px;left:1px;width:48px;height:48px;background:#f6f6f7;color:#b5b8c2;text-align:center;line-height:50px;-webkit-border-top-left-radius: 2px; -webkit-border-bottom-left-radius: 2px; -moz-border-radius-topleft: 2px; -moz-border-radius-bottomleft: 2px; border-top-left-radius: 2px; border-bottom-left-radius: 2px;}
	&.color-2 .form-input{background:#f6f6f7;}
	&.color-3 .form-input{background:#383b43;color:#fff;}
	&.color-4 .form-input{background:#0d58c8;color:#fff;}
	&.focus-2 .form-input:focus{background:#f6f6f7;}
}
...
.form-checkbox{
	...
	> input{position:absolute; width:20px;height:20px;z-index:2;opacity: 0;}
	> input + .check {position:relative; top:5px; display:inline-block; width:20px; height:20px; border:1px solid #edeff2; color:#0d58c8; cursor:pointer; z-index: -1;}
	> input + .check .fa{position:absolute;top:2px;left:2px; display:none;opacity:0;}
	> input:checked + span .fa{display:block; opacity:1;}
	&.style-2 > input + .check{-webkit-border-radius: 20px; -moz-border-radius: 20px; border-radius: 20px;}
	&.style-2 > input + .check .fa{display:none;}
	&.style-2 > input:checked + .check:before{content:'';display:block;width:8px;height:8px;position:absolute;top:50%;left:50%; margin-top:-4px; margin-left:-4px; background:#4a82d6;-webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px;}
}
/*alerts*/
.alert{
	position:relative; font-size:13px; line-height:22px; color:#7a8192; padding:21px 21px 21px 60px;; background:#f6f6f7; border:1px solid #edeff2; margin-bottom:20px; -webkit-border-radius: 3px;-moz-border-radius: 3px; border-radius: 3px;
	.close{position:absolute;top:21px;left:21px;width:24px; height:24px; font-size: 11px; background:#0d58c8; color:#fff;opacity:1;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;}
	.alert-title{font-size:14px;line-height:18px;font-family: 'Conv_helveticaneuecyr-bold';color:#383b43;margin-bottom: 10px;}
	&.style-2{background:#0d58c8;color:#8ba1dd;}
	&.style-2 .close{background:#fff;color:#5b5e64;}
	&.style-2 .alert-title{color:#fff;}
	&.style-3{background:#383b43;color:#b4b7c1;}
	&.style-3 .alert-title{color:#fff;}
}
/*accordion*/
.accordion.style-1{
	border:1px solid #edeff2;-webkit-border-radius: 2px; -moz-border-radius: 2px; border-radius: 2px;
	.acc-title{position:relative;font-size:13px;line-height:18px;color:#b4b7c1;background:#f6f6f7;padding: 11px 45px 11px 15px;cursor:pointer;border-bottom:1px solid #edeff2;}
	.acc-panel:last-child .acc-title{border-bottom:0px;}
	.acc-title.active{background:#0d58c8;color:#fff;}
	.acc-title:after{content:"\f078";display:inline-block;position:absolute;top:0px;right:15px;font: normal normal normal 14px/1 FontAwesome;font-size: 14px;line-height:37px;color:transparent;text-rendering: auto;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;transform: translate(0, 0)}
	.acc-title.active:after{color:#8da4e0;}
	.acc-body{display:none;font-size:13px;line-height:18px;padding:27px 40px 25px 40px;}
	.acc-body.active{display:block;}
	.acc-body p{margin-bottom:15px;}
	.acc-body a{color:#b4b7c1;}
	.acc-body a:hover{color:#0d58c8;}
}
.accordion.style-2{
	.acc-panel{margin-bottom:10px;border:1px solid #edeff2;}
	.acc-panel:last-child .acc-title{border-bottom:0px;}
	.acc-title{position:relative;font-size:14px;line-height:21px;color:#383b43;background:#fff;padding: 14px 45px 14px 70px;cursor:pointer;}
	.acc-icon{position:absolute;top:0px;left:0px;bottom:0px;width:50px;background:#f6f6f7;}
	.acc-icon:before{content: "\f067";position:absolute;top:50%;left:50%;display:block;width:14px;height:14px;margin-top:-7px;margin-left:-7px;color:#b4b7c1;text-align:center; font: normal normal normal 14px/1 FontAwesome;font-size: inherit; text-rendering: auto; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; transform: translate(0, 0);}
	.acc-title.active{background:#f6f6f7;border-bottom:1px solid #edeff2;}
	.acc-title.active .acc-icon{background:#0d58c8;}
	.acc-title.active .acc-icon:before{content: "\f068";color:#8da4e0;}
	.acc-body{display:none;background:#f6f6f7; color:#7a8192; font-size:13px;line-height:22px;padding:25px 30px 25px 30px;}
	.acc-body.active{display:block;}
	.acc-body p{margin-bottom:20px;}
}
...
.collection-entry{padding:10px;border:1px solid #edeff2;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;}
/*-------------------------------------------------------------------------------------------------------------------------------*/
/* 04 - BLOG */
/*-------------------------------------------------------------------------------------------------------------------------------*/
...
.blog-post{
	border:1px solid #edeff2;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;overflow: hidden; margin-bottom:50px;
	.post-desc{margin-top:24px;margin-right:40px;}
	.post-category{font-size:11px;line-height:16px;font-weight:400;color:#b4b7c1; padding-bottom:24px; margin-bottom:24px; border-bottom:1px solid #edeff2;}
	.post-label{display:block; font-size:24px;line-height:26px;font-weight:400;color:#383b43;margin-bottom:20px;}
	a.post-label:hover{color: #0d58c8;}
	.post-text{font-size:12px;line-height:22px;color:#b4b7c1;padding-bottom:27px;margin-bottom:23px;border-bottom:1px solid #edeff2;}
	.author-post{padding-left:0px;}
	.post-image{display:block; overflow:hidden;}
	.post-image img{-moz-transition:all 0.3s ease-out; -ms-transition:all 0.3s ease-out; -o-transition:all 0.3s ease-out; -webkit-transition:all 0.3s ease-out; transition:all 0.3s ease-out;}
	.post-image:hover img{-webkit-transform:scale(1.1); -moz-transform:scale(1.1); -o-transform:scale(1.1); -ms-transform:scale(1.1); transform:scale(1.1); }
	.post-image.play{position:relative;}
	.post-image.play:before{content:'';display:block;position:absolute;top:50%;left:50%;width:60px;height:60px;margin-left:-30px;margin-top:-30px;background:url(../img/play.png) no-repeat;z-index:100;}
	&.be-large-post .post-preview{margin-bottom:50px;}
	&.be-large-post .post-text{margin-bottom:20px;padding-bottom:0px;border-bottom:none;}
	&.be-large-post .info-block .be-text-tags{float:right;}
	&.be-large-post .post-date{float:left;}
	&.be-large-post .author-post{float:right;}
	&.be-large-post .post-date .fa{font-size: 16px;position: relative;top: 1px;}
}
.blog-list{
	.info-block{padding-left:30px; margin-left:-30px; margin-right: -40px;}
}
.blog-grid{
	.post-header{padding:14px 18px;}
	.post-header .post-date{float:left;font-size:12px;font-weight:400;color:#b4b7c1;}
	.post-header .post-date .fa{font-size:16px;position:relative;top:1px;}
	.post-header .author-post{float:right;}
	.post-desc{padding:25px 20px 0px 20px;margin:0px;}
	.post-category{font-size:10px;line-height:15px;}
	.post-text{border-bottom:none;padding-bottom:0px;margin-bottom:15px;}
	.blog-post .btn{margin-bottom:30px;}
...
.pagination{
	text-align:center;
	.page-left{float:left;display:block;height:35px;line-height:35px;text-transform: lowercase; padding: 0px 20px;}
	.page-right{float:right;display:block;height:35px;line-height:35px;text-transform: lowercase; padding: 0px 20px;}
	.pages .btn{width:35px;padding:10.5px 0px;margin-right:8px;}
}
#content-block .pagination .pages .btn:last-child{margin-bottom:10px;}
.simple-slider .pagination{
	position:absolute;bottom:0px;left:0px;margin-bottom:11px!important;
...
blockquote {position: relative; font-size: 24px; line-height: 34px; font-family: 'Conv_helveticaneuecyr-bold'; color: #383b43; text-transform: uppercase; padding: 40px 130px 50px 130px; background: #f6f6f7; border:none;
	...
	footer{font-size: 12px; line-height:16px; font-weight: 400; color: #383b43; text-align: right; text-transform: none; background:transparent; margin-right: -60px;}
	&:before {content: ''; position: absolute; top: 50px; left: 70px; display: block; width: 32px; height: 28px; background: url(../img/blockquote-l.png) no-repeat;}
	&:after{content: ''; position: absolute; bottom: 80px; right: 70px; display: block; width: 32px; height: 28px; background: url(../img/blockquote-r.png) no-repeat;}
}
.blog-content{
	margin-bottom:45px;
	.post-text {font-size:13px;line-height:22px;font-weight:400;color:#a1a5b1;}
	p{margin-bottom:25px;}
	img{max-width:100%;margin-top:20px;margin-bottom:45px;}
	img[align="left"] {margin-right:30px;}
	img[align="right"] {margin-left:30px;}
	.img-fullblog{max-width:1920px;margin-left:-65px;margin-right:-65px;}
	.img-leftblog{margin-left:-65px;}
	.img-rightblog{max-width:1920px;margin-right:-65px;}
	blockquote{margin-left: -65px;margin-right: -65px;margin-bottom:25px;}
	.embed-responsive{margin-bottom:50px;}
	.image-block{margin-top:45px;margin-bottom:45px;}
	.image-block img{margin-top:0px;margin-bottom:0px;}
	.image-block + img{margin-top:0px;}
}
/*list*/
.blog-content ul, ul.styled{
	list-style:none;margin-bottom:25px;
	li{position:relative; font-size:13px; line-height:18px; font-weight:400; color:#7a8192; margin-bottom:15px;}
	li:before{content:''; display:inline-block; position:relative; top:-2px;  width:5px; height:5px; margin-right:13px; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; background:#0d58c8;}
	&.style-2 li{padding-left:23px;}
	&.style-2 li:before{content: "\f00c"; position:absolute; top:1px; left:0px; width:auto; height:auto; background:transparent; display: inline-block;font: normal normal normal 14px/1 FontAwesome;font-size: inherit;text-rendering: auto;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;transform: translate(0, 0);}
	&.style-3 li{padding-left:26px;}
	&.style-3 li:before{display:none;}
	&.style-3 li .fa{position:absolute;top:0px;left:0px;color:#b9bcc5;}
}
ol.styled{
	list-style:none;margin-bottom:20px;
	li{position:relative;counter-increment:section;font-size:13px; line-height:18px; font-weight:400; color:#7a8192; padding-left:35px; margin-bottom:15px;}
	li:before{content:counter(section);position:absolute;top:-5px;left:0px; display:inline-block;width:25px;height:25px;-webkit-border-radius: 25px; -moz-border-radius: 25px; border-radius: 25px;background:#0d58c8;color:#fff;text-align:center;padding-top: 4px;padding-right: 1px;}
}
...
/*tabs*/
.tab-wrapper.style-1, .tab-wrapper.style-2, .tab-wrapper.style-3{
	.nav-tab{border-bottom:1px solid #edeff2;}
	.nav-tab-item{display:block;float:left;cursor:pointer;background:#f6f6f7;border:1px solid #edeff2;}
	.nav-tab-item{-webkit-border-top-left-radius:2px;-webkit-border-top-right-radius:2px;-moz-border-radius-topleft:2px;-moz-border-radius-topright:2px;border-top-left-radius:2px;border-top-right-radius:2px;}
	.nav-tab-item span{display:block;font-size:13px;line-height:13px;padding:16.5px 30px;}
	.nav-tab-item.active{background:#fff;color:#383b43;border-bottom:1px solid #fff;}
	.tab-nav-wrapper{margin-bottom:40px;}
...
.tab-wrapper.style-3{
	...
	.tabs-content{border:1px solid #edeff2;border-top:none;}
}
#content-block .tab-wrapper.style-1 .nav-tab-item,
#content-block .tab-wrapper.style-3 .nav-tab-item{margin-bottom: -1px;}
.tab-wrapper.color-2{
	.nav-tab-item{background: #383b43;color:#848891;border: 1px solid #2d3038;}
	.nav-tab-item.active{border: 1px solid #edeff2;border-bottom:1px solid #fff;}
}
...
/* 04 - CONTACT */
/*-------------------------------------------------------------------------------------------------------------------------------*/
.contact-info{border:1px solid #edeff2;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;margin-bottom:40px;}
...
.team-entry{border:1px solid #edeff2;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;}
...
.testimonals-entry{border:1px solid #edeff2;padding:50px 20px;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;}
.testimonals-img{display:block;width:100px;height:100px;margin:0 auto 15px auto;-webkit-border-radius: 100px;-moz-border-radius: 100px;border-radius: 100px;}
...
.block{
	...
	.block-title{font-size:32px;line-height:28px;margin-bottom:10px;text-align:center;font-family: 'Conv_helveticaneuecyr-bold';}
	.block-subtitle{font-size:16px;line-height:20px;font-weight:400;color:#b4b7c1;text-align:center;margin-bottom:40px;}
}
...
.table-responsive{border:1px solid #edeff2;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;}
...
.t_project_icon{display:inline-block;width:40px;height:40px;margin-right:10px;-webkit-border-radius: 40px;-moz-border-radius: 40px;border-radius: 40px;}
...
/*  CSS ANIMATIONS */
/*-------------------------------------------------------------------------------------------------------------------------------*/
a, .soc_buttons.light > li, .color_bg, .be-ava-user > img, .be-drop-down, .footer_slider img{-moz-transition:all 0.15s ease-out; -o-transition:all 0.15s ease-out; -webkit-transition:all 0.15s ease-out; -ms-transition:all 0.15s ease-out; transition:all 0.15s ease-out;}

.be-drop-down{-moz-transition:all 0.5s ease-out; -o-transition:all 0.5s ease-out; -webkit-transition:all 0.5s ease-out; -ms-transition:all 0.5s ease-out; transition:all 0.5s ease-out;}
/*-------------------------------------------------------------------------------------------------------------------------------*/
/*  BOOTSTRAP XL */
/*-------------------------------------------------------------------------------------------------------------------------------*/
